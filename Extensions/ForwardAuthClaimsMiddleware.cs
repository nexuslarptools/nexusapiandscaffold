...
namespace NEXUSDataLayerScaffold.Extensions
{
    ...
    public class ForwardAuthClaimsMiddleware
    {
        ...
        {
            // Do not inject/forward Authorization header; keep API strictly Bearer-based.
            // Only create a principal if there is no Authorization header and the proxy supplied identity headers
